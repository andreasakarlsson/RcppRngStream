...
.RcppRngStream.init <- function () {
  .Call("r_create_current_stream",PACKAGE="RcppRngStream")
  return(1)
}

.RcppRngStream.exit <- function () {
  .Call("r_remove_current_stream",PACKAGE="RcppRngStream")
  return(1)
}
